...
class FuturesBotSerializer(serializers.Serializer):
    ...
    final_pnl = serializers.FloatField(allow_null=True, required=True)
    final_pnl_percentage = serializers.FloatField(allow_null=True, required=True)
