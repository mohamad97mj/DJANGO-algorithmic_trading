...
#                     state_data.balance_data.purchased_size,
...
#                         price=price,
#                         amount=state_data.balance_data.purchased_size,
#                         position=position
#                     )
...
#             state_data.balance_data.purchased_size += exchange_order['amount'] - exchange_order['fee']['cost']
#         elif exchange_order['side'] == 'sell':
#             state_data.balance_data.purchased_size -= exchange_order['amount']
...
#         balance_data.purchased_size += pure_buy_amount
...
#         balance_data.purchased_size -= truncated_sell_amount_before_fee
#
...
#                                                     result_data=result_data1)
#
#         amount_in_quote1 = balance_data1.available_margin + balance_data1.purchased_size * shlc_data.closing_price
#
...
#                                                    result_data=result_data2)
#
#         amount_in_quote2 = balance_data2.available_margin + balance_data2.purchased_size * shlc_data.closing_price
#
...
#                                     sell_amount=balance_data.purchased_size,
